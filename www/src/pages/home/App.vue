      ...
      <div class="px-3 mt-5">
        ...
        <div class="mt-1 relative rounded-md shadow-sm">
          <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" aria-hidden="true">
            <SearchIcon class="mr-3 h-4 w-4 text-gray-400" />
          </div>
...
import { HomeIcon, MenuAlt1Icon, XIcon, AdjustmentsIcon } from "@heroicons/vue/outline";
import { LogoutIcon, SearchIcon } from "@heroicons/vue/solid";
